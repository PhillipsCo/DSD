        ...
        try
        {
            ...
            var host = Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddTransient<SqlCountAppRunner>();
                })
                .Build();


            using var scope = host.Services.CreateScope();
            var appRunner = scope.ServiceProvider.GetRequiredService<SqlCountAppRunner>();
            await appRunner.RunAsync(args);


            Log.Information("DSD SqlCount application completed successfully.");
        }
        catch (Exception ex)
        {
